...
<head>
    ...
    $installments = $get_instalments;

    ?>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link href="{{ asset('laravel_assets/css/bootstrap-5.13-dist/bootstrap.min.css') }}" rel="stylesheet"
    ...
    <link href="{{ asset('laravel_assets/fontawesome-free-6.1.1-web/css/all.min.css') }}" rel="stylesheet"
        crossorigin="anonymous" />
...
<body>
        ...
        <div class="container mt-5 billing">
            <div class="row">
                ...
                @if (count($d['installements']) > 0)
                    <div class="col-lg-7 col-md-12">
                        <div class="card mb-4">
                            ...
                            <div class="d-flex justify-content-space-between mb-1">
                                ...
                                <input type="hidden" name="voucher_unique_id_value" value=""
                                    id="voucher_unique_id_value">
                            </div>
                            <div class="d-flex justify-content-space-between">
                                <div class="size-16 grey-text">Voucher / Promo Code </div>
                                <a data-bs-toggle="modal" data-bs-target="#modalVoucher" style="display: flex;"
                                    class="size-16 font-700 primary-color"><span id="show_select"
                                        style="display: block;">Select&nbsp;</span><span
                                        id="discount_amount_show"></span><span>
                                        <svg width="7" height="12" viewBox="0 0 7 12" fill="none"
                                            xmlns="#">
                                            <path d="M1 1.33334L5.66667 6L1 10.6667" stroke="{{ $color_code_600 }}"
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <span class="payment-checkbox">
                                                                        <input type='radio' name='a' checked
                                                                            onchange="getPayAmount(1)"
                                                                            value="1" />
                                                                    </span>
                                                                    Pay Now
                                                                </div>
                                                                <div class="text-end first" id="firstSequenceAmount">
                                                                    RM
                                                ...
                                                <div class="accordion-item">
                                                    <h2 class="accordion-header" id="headingTwo">
                                                        <button class="accordion-button collapsed" type="button"
                                                            ...
                                                            aria-controls="collapseTwo" onclick="getPayAmount(2)">
                                                            <div class="row flex-nowrap align-items-center">
                                                                <div class="d-flex align-items-center">
                                                                    <span class="payment-checkbox">
                                                                ...
                                                                <ul class="timeline mt-2">
                                                                    <li class="timeline-item">
                                                                        ...
                                                                        <div class="timeline-content">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col">
                                                                                    <div class="time">Credit Shield Fee</div>
                                                                                </div>
                                                                                <div class="col" style="text-align: end; padding-right: 17px;">
                                                                                    <p id="creditshieldfee_view_second">RM {{ number_format($installments[0]['credit_shield_protection'], 2) }}</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    ...
                                                                    <li class="timeline-item">
                                                                        ...
                                                                        <div class="timeline-content">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col" style="text-align: end; padding-right: 17px;">
                                                                                    <p id="creditshieldfee_view_third">RM {{ number_format($installments[1]['credit_shield_protection'], 2) }}</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    ...
                                                                    <li class="timeline-item">
                                                                        ...
                                                                        <div class="timeline-content">
                                                                            ...
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col" style="text-align: end; padding-right: 17px;">
                                                                                    <p id="creditshieldfee_view_sixth">RM {{ number_format($installments[2]['credit_shield_protection'], 2) }}</p>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                        ...
                                        @if ($card['is_default'] == 1)
                                            @if ($card['card_type'] != null)
                                                @if ($card['card_type'] == 'Visa')
                                                    <span class="mr-1">
                                                        <img src="{{ asset('laravel_assets/card/visa.svg') }}"
                                                            id="card_image" alt="" width="28"
                                                            height="16">
                                                    </span>
                                                    <span id="selected_card">{{ $card['card_no'] }}</span>
                                                @elseif($card['card_type'] == 'Master')
                                                    <span class="mr-1">
                                                        <img src="{{ asset('laravel_assets/card/mastercard.svg') }}"
                                                            id="card_image" alt="" width="28"
                                                            height="16">
                                                    </span>
                                                    <span id="selected_card">{{ $card['card_no'] }}</span>
                                                @elseif($card['card_type'] == 'AmericanExpress')
                                                    <span class="mr-1">
                                                        <img src="{{ asset('laravel_assets/card/American-Express.jpg') }}"
                                                            id="card_image" alt="" width="28"
                                                            height="16">
                                                    </span>
                                                    <span id="selected_card">{{ $card['card_no'] }}</span>
                                                @elseif($card['card_type'] == 'Discover')
                                                    <span class="mr-1">
                                                        <img src="{{ asset('laravel_assets/card/discover.png') }}"
                                                            id="card_image" alt="" width="28"
                                                            height="16">
                                                    </span>
                                                    <span id="selected_card">{{ $card['card_no'] }}</span>
                                                @elseif($card['card_type'] == 'Diners')
                                                    <span class="mr-1">
                                                        <img src="{{ asset('laravel_assets/card/diners.jpeg') }}"
                                                            id="card_image" alt="" width="28"
                                                            height="16">
                                                    </span>
                                                    <span id="selected_card">{{ $card['card_no'] }}</span>
                                                ...
                                                @elseif($card['card_type'] == 'Jcb')
                                                    <span class="mr-1">
                                                        <img src="{{ asset('laravel_assets/card/jcb.png') }}"
                                                            id="card_image" alt="" width="28"
                                                            height="16">
                                                    </span>
                                                    <span id="selected_card">{{ $card['card_no'] }}</span>
                                                @elseif($card['card_type'] == 'Visa Electron')
                                                    <span class="mr-1">
                                                        <img src="{{ asset('laravel_assets/card/visa-electron.png') }}"
                                                            id="card_image" alt="" width="28"
                                                            height="16">
                                                    </span>
                                                    <span id="selected_card">{{ $card['card_no'] }}</span>
                                                @else
                                                    <span class="mr-1">
                                                        <img src="{{ asset('laravel_assets/card/other_card.png') }}"
                                                            id="card_image" alt="" width="28"
                                                            height="16">
                                                    </span>
                                                    <span id="selected_card">{{ $card['card_no'] }}</span>
                                                                        ...
                                                                        @if ($card['card_type'] == 'Visa')
                                                                            ...
                                                                            @if ($card['is_default'] == 1)
                                                                                <input type="radio"
                                                                                    ...
                                                                                    checked
                                                                                    id="card{{ $card['id'] }}"
                                                                                    onchange="changeDefaultCard('{{ $card['card_no'] }}','{{ $card['card_type'] }}')">
                                                                                <label
                                                                                    for="card{{ $card['id'] }}">{{ $card['card_no'] }}</label>
                                                                            @else
                                                                                <input type="radio"
                                                                                    value="{{ $card['id'] }}"
                                                                                    name="payment_method_id"
                    ...
                    <div id="add-card" style="display:none;">
                        <div class="card mb-5">
                                ...
                                <div class="col-3">
                                    <div class="exp-wrapper">
                                        <input autocomplete="off" class="exp" id="month" maxlength="2"
                                            pattern="[0-9]*" inputmode="numerical" placeholder="MM"
                                            type="text" data-pattern-validate class="input-field" />
                                        <input autocomplete="off" class="exp" id="year" maxlength="2"
                                            pattern="[0-9]*" inputmode="numerical" placeholder="YY"
                                            type="text" data-pattern-validate class="input-field" />
                                    </div>
                                </div>
                                <div class="col-3">
                            ...
                            <div class="grey-text size-12 text-center mt-3">I acknowledge that my card information
                                is saved to my {{ $platformname }} account and a One Time Password (OTP) may not
                        ...
                        @if ($d['bill_details']['billing_stage_id'] != 1)
                            ...
                            @else
                                @if ($d['billPaytime'] > 600)
                                    ...
                                    <div class="d-flex align-items-center justify-content-center mt-3 mb-4">
                                    @else
                                        <div class="size-16 font-700 primary-text">Pay with the
                                            {{ $platformname }} app</div>
                                        <div class="d-flex align-items-center justify-content-center mt-3 mb-4">
                                            ...
                                            @if (!empty($d['bill_details']))
                                                ...
                                                @if ($d['bill_details']['user_id'] == null)
                                                    ...
                                                    <div class="size-14 font-600 primary-text text-center ml-3">
                                                        Scan
                                                        this QR with the
                                                        {{ $platformname }}
                                                        app
                    ...
                    <div class="action text-center">
                        @if (count($d['all_card']))
                            ...
                            @else
                                ...
                                display: none;
                            ">Payment
                                    is being proceeded. Please do not refresh the page.</label>
                                @if (isset($d['bill_details']['return_url']))
                                    <button class="cancel-button mt-2" id="cancel"
                                        onclick="cancelBill('{{ $d['bill_details']['bill_code'] }}','{{ $d['bill_details']['return_url'] }}');">Cancel
                                        Bill</button>
                                @endif
                            @endif
                        @else
                ...
                @if ($d['bill_details']['merchant_home_url'])
                    <div class="action">
                        <button onclick="location.href='{{ $d['bill_details']['merchant_home_url'] }}';"
                            class="button-23 w-100" id="back_to_merchant">← Redirect back to Merchant
                            page</button>
                    </div>
                @else
                @endif
                ...
                <div class="col-lg-12 col-md-12">
                    <div id="pageMessages">
                        <div class="alert animated flipInX alert-danger alert-dismissible">
                            ...
                            <strong>We are sorry, you are not eligible to proceed with the payment due to merchant
                                payment option not supported.</strong>
                        </div>
                    </div>
                    @if ($d['bill_details']['merchant_home_url'])
                ...
                <div class="modal-body text-center">
                    <svg width="35" height="35" viewBox="0 0 40 40" fill="none"
                        ...
                        <path
                            ...
                            stroke="{{ $color_code_600 }}" stroke-width="4" stroke-linecap="round"
                            stroke-linejoin="round" />
                    </svg>
                    ...
                    <div class="size-14 primary-text mb-2">The option you've selected is completely interest-free.
                        A late payment fee will only be charged if you don't pay on time. At {{ $platformname }},
                        we want to
    ...
    <div class="modal fade" id="modal_T_C" tabindex="-1" aria-labelledby="verifyModalLabel" aria-hidden="true"
        style="z-index: 9999;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <div class="size-14 mt-2">
                        Download the <span class="font-700"> {{ $platformname }} app</span> and verify your MyKad
                        to get up to
    ...
    <div class="modal fade" id="passcode_1" tabindex="-1" aria-labelledby="passcode_1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                            ...
                            <div class="p-2 text-center">
                                <div id="otp" class="inputs d-flex flex-row justify-content-center mt-2">
                                    <input class="m-2 text-center form-control rounded passcode" type="number"
                                        id="first_passcode_1" maxlength="1"
                                        onkeypress="return isNumberKey(event)" required />
                                    <input class="m-2 text-center form-control rounded passcode" type="number"
                                        id="second_passcode_1" maxlength="1"
                                        onkeypress="return isNumberKey(event)" />
                                    <input class="m-2 text-center form-control rounded passcode" type="number"
                                        id="third_passcode_1" maxlength="1"
                                        onkeypress="return isNumberKey(event)" />
                                    <input class="m-2 text-center form-control rounded passcode" type="number"
                                        id="fourth_passcode_1" maxlength="1"
                                        onkeypress="return isNumberKey(event)" />
                                    <input class="m-2 text-center form-control rounded passcode" type="number"
                                        id="fifth_passcode_1" maxlength="1"
                                        onkeypress="return isNumberKey(event)" />
                                    <input class="m-2 text-center form-control rounded passcode" type="number"
                                        id="sixth_passcode_1" maxlength="1"
                                        onkeypress="return isNumberKey(event)" />
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer border-0">
                    <a href="#">
                        <button type="button" class="primary-button"
                            onclick="click_passcode_1_next()">Next</button>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                    ...
                    <div class="container mb-4 d-flex justify-content-center align-items-center">
                        <div class="position-relative">
                            <div class="p-2 text-center">
                                <div id="otp" class="inputs d-flex flex-row justify-content-center mt-2">
                                    <input class="m-2 text-center form-control rounded passcode" type="number"
                                        id="first_passcode_2" maxlength="1"
                                        onkeypress="return isNumberKey(event)" required />
                                    <input class="m-2 text-center form-control rounded passcode" type="number"
                                        id="second_passcode_2" maxlength="1"
                                        onkeypress="return isNumberKey(event)" />
                                    <input class="m-2 text-center form-control rounded passcode" type="number"
                                        id="third_passcode_2" maxlength="1"
                                        onkeypress="return isNumberKey(event)" />
                                    <input class="m-2 text-center form-control rounded passcode" type="number"
                                        id="fourth_passcode_2" maxlength="1"
                                        onkeypress="return isNumberKey(event)" />
                                    <input class="m-2 text-center form-control rounded passcode" type="number"
                                        id="fifth_passcode_2" maxlength="1"
                                        onkeypress="return isNumberKey(event)" />
                                    <input class="m-2 text-center form-control rounded passcode" type="number"
                                        id="sixth_passcode_2" maxlength="1"
                                        onkeypress="return isNumberKey(event)" />
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer border-0">
                    <a href="#">
                        <button type="button" class="primary-button"
                            onclick="click_passcode_2_next()">Submit</button>
                    </a>
                </div>
            </div>
        </div>
...
<script>
    ...
    var is_upfront_percentage_avail = parseInt(
        "{{ $d['bill_details']['get_merchant']['change_upfront_payment'] ? $d['bill_details']['get_merchant']['change_upfront_payment'] : 0 }}"
        );
    var upfront_percentage = parseFloat("{{ $d['bill_details']['get_merchant']['upfront_payment_percentage'] }}")
        .toFixed(2);
    ...
    var return_shopify_url =
        "{{ $d['bill_details']['return_url'] != null ? $d['bill_details']['return_url'] : 'null' }}";

    var creditShieldFeeFor2 = {{ $installments[0]['credit_shield_protection'] }};
    var creditShieldFeeFor3 = {{ $installments[1]['credit_shield_protection'] }};
    var creditShieldFeeFor6 = {{ $installments[2]['credit_shield_protection'] }};

    function payment_calculations() {
        var creditShieldFee = 0;

        if (billing_sequence == 2) {
            creditShieldFee = creditShieldFeeFor2;
        } else if (billing_sequence == 3) {
            creditShieldFee = creditShieldFeeFor3;
        } else if (billing_sequence == 6) {
            creditShieldFee = creditShieldFeeFor6;
        }
        ...
        if (billing_sequence != 1) {
            ...
            for (var i = 1; i < billing_sequence; i++) {
                ...
                // if (billing_sequence == 2) {
                //     // Add the credit shield fee to the first installment
                //     instAmounts[0] = (parseFloat(instAmounts[0]) + creditShieldFeeFor2).toFixed(2);
                //     $('#firstSequenceAmountFor2').html('RM ' + parseFloat(instAmounts[0]).toFixed(2));
                // } else if (billing_sequence == 3) {
                //     // Add the credit shield fee to the first installment
                //     instAmounts[0] = (parseFloat(instAmounts[0]) + creditShieldFeeFor3).toFixed(2);
                //     $('#firstSequenceAmountFor3').html('RM ' + parseFloat(instAmounts[0]).toFixed(2));
                // } else if (billing_sequence == 6) {
                //     // Add the credit shield fee to the first installment
                //     var totalForToday = parseFloat(firstSequenceAmountFor6) + parseFloat(processing_fee) + creditShieldFeeFor6;

                //     // Update the first installment amount with the credit shield fee
                //     instAmounts[0] = (parseFloat(firstSequenceAmountFor6) + parseFloat(processing_fee) + creditShieldFeeFor6).toFixed(2);

                //     // Display the updated "Pay Today" amount
                //     $('#firstSequenceAmountFor6').html('RM ' + instAmounts[0]);
                // }
            }
    ...
    //         $('#firstSequenceAmount').html('RM ' + parseFloat(parseFloat(net_amount_temp) + parseFloat(processing_fee))
    //             .toFixed(2));
    //     }
    //     if (sequence == 2) {
    //         if (is_voucher_applied || promocode != '') {
    ...
    function calculatePayLaterTotalValue(sequence) {
        ...
        const promocode_value = document.getElementById("input1");
        const promocode = promocode_value.value;
        const is_voucher_applied = $('input[name="check_voucher"]').is(":checked");
        const whole = Math.trunc(net_amount);
        let sequenceAmountTemp = parseInt(whole / sequence).toFixed(2);
        let firstSequenceAmountTemp = net_amount - (sequenceAmountTemp * (sequence - 1));

        // Credit Shield Fees
        const creditShieldFeeFor2 = {{ $installments[0]['credit_shield_protection'] }};
        const creditShieldFeeFor3 = {{ $installments[1]['credit_shield_protection'] }};
        const creditShieldFeeFor6 = {{ $installments[2]['credit_shield_protection'] }};
        ...
        function handleSpendingLimit() {
            if (spending_limit < 0) {
                ...
                const sequenceAmountTemp_new = parseInt(spending_limit / sequence).toFixed(2);
                if (is_upfront_percentage_avail === 1) {
                    const sequenceAmt = net_amount - (sequenceAmountTemp_new * (sequence - 1));
                    if (firstSequenceAmountTemp < sequenceAmt) {
                        sequenceAmountTemp = sequenceAmountTemp_new;
                        firstSequenceAmountTemp = sequenceAmt;
                    }
        ...
        function calculateProcessingFee(sequenceType) {
            let fixed_processing_fee = parseFloat($(`#${sequenceType}processing_fee_rate_fixed`).val());
            let processing_fee_percentage = parseFloat($(`#${sequenceType}processing_fee_rate_percentage`).val());
            let processing_fee = parseFloat(((bill_amount * processing_fee_percentage) / 100));
            return parseFloat(processing_fee + fixed_processing_fee).toFixed(2);
        }

        function getCreditShieldFee(sequence) {
            switch (sequence) {
                case 2:
                    return creditShieldFeeFor2;
                case 3:
                    return creditShieldFeeFor3;
                case 6:
                    return creditShieldFeeFor6;
                default:
                    return 0;
            }
        }
        switch (sequence) {
            ...
            case 2:
                var creditShieldFee = creditShieldFeeFor2;
                if (is_voucher_applied || promocode != '') {
                    if (discountType == 1 && sequenceAmountTemp < discount) {
                        firstSequenceAmountFor2 = firstSequenceAmountTemp - (discount - sequenceAmountTemp);
                    } else {
                        firstSequenceAmountFor2 = firstSequenceAmountTemp;
                    }
                } else {
                ...
                processing_fee = parseFloat(((bill_amount * processing_fee_percentage) / 100));
                processing_fee = parseFloat(processing_fee + fixed_processing_fee).toFixed(2);
                $('#firstSequenceAmountFor2').html('RM ' + parseFloat(parseFloat(firstSequenceAmountFor2) + parseFloat(processing_fee) + creditShieldFee).toFixed(2));
                break;

            case 3:
                var creditShieldFee = creditShieldFeeFor3;
                if (is_voucher_applied || promocode != '') {
                    if (discountType == 1 && (sequenceAmountTemp * 2) < discount) {
                        firstSequenceAmountFor3 = firstSequenceAmountTemp - (discount - (sequenceAmountTemp * 2));
                    } else {
                        firstSequenceAmountFor3 = firstSequenceAmountTemp;
                    }
                } else {
                ...
                processing_fee = parseFloat(((bill_amount * processing_fee_percentage) / 100));
                processing_fee = parseFloat(processing_fee + fixed_processing_fee).toFixed(2);
                $('#firstSequenceAmountFor3').html('RM ' + parseFloat(parseFloat(firstSequenceAmountFor3) + parseFloat(processing_fee) + creditShieldFee).toFixed(2));
                break;

            case 6:
                var creditShieldFee = creditShieldFeeFor6;
                if (is_voucher_applied || promocode != '') {
                    if (discountType == 1 && (sequenceAmountTemp * 5) < discount) {
                        firstSequenceAmountFor6 = firstSequenceAmountTemp - (discount - (sequenceAmountTemp * 5));
                    } else {
                        firstSequenceAmountFor6 = firstSequenceAmountTemp;
                    }
                } else {
                ...
                processing_fee = parseFloat(((bill_amount * processing_fee_percentage) / 100));
                processing_fee = parseFloat(processing_fee + fixed_processing_fee).toFixed(2);
                $('#firstSequenceAmountFor6').html('RM ' + parseFloat(parseFloat(firstSequenceAmountFor6) + parseFloat(processing_fee) + creditShieldFee).toFixed(2));
                break;

            default:
                console.error("Unsupported sequence value:", sequence);
        }


        function handleSequence(seqNum, seqName, seqAmountTemp, disc) {
            let firstSequenceAmount = firstSequenceAmountTemp;
            if (is_voucher_applied || promocode !== '') {
                if (discountType === 1 && (seqAmountTemp * (seqNum - 1)) < disc) {
                    firstSequenceAmount -= (disc - (seqAmountTemp * (seqNum - 1)));
                }
            }
            const processing_fee = calculateProcessingFee(seqName);
            const totalForToday = parseFloat(firstSequenceAmount) + parseFloat(processing_fee) + getCreditShieldFee(seqNum);

            $(`#firstSequenceAmountFor${seqNum}`).html('RM ' + totalForToday.toFixed(2));

            // Update "Pay Today" amount if it's the first sequence
            if (seqNum === 1) {
                $('#payTodayAmount').html('RM ' + totalForToday.toFixed(2));
            }
        }
    ...
    function renderHtml() {
        ...
        if (billing_sequence == 1) {
            ...
            $('#firstSequenceAmount').html('RM ' + parseFloat(parseFloat(instAmounts[0]) + parseFloat(processing_fee))
                .toFixed(2));
        ...
        // calculateWithCreditShield();
        var selectedPaymentMethod = $('input[name="payment_method_id"]:checked').val();
        // var totalWithCreditShield = parseFloat($('#pay_amount_value').val());
        // $('#pay_amount').html('RM ' + totalWithCreditShield.toFixed(2));
        // $('#pay_amount_value').val(totalWithCreditShield.toFixed(2));

    }


    // function calculateWithCreditShield() {
    //     $.ajax({
    //         type: "GET",
    //         success: function(response) {
    //             if (response.status === 'Success') {
    //                 applyCreditShieldToPayment(response.data);
    //                 var originalAmount = parseFloat($('#amount').val());

    //                 $('input[name="payment_method_id"]').change(function() {
    //                     $('#amount').val(originalAmount); // Reset to original amount
    //                     // Remove the previously added credit shield fee div
    //                     $('#credit_shield_fee_div').remove();
    //                 });
    //             }
    //         },
    ...
    function applyCreditShieldToPayment(instalments) {
        $('input[name="payment_method_id"]').change(function() {
            var selectedPaymentMethod = $('input[name="payment_method_id"]:checked').val();

            // Find the installment data for the selected payment method
            var installmentData = instalments.find(function(installment) {
                return installment.id.toString() === selectedPaymentMethod;
            });

            if (installmentData && installmentData.credit_shield_protection) {
                var creditShieldFee = installmentData.credit_shield_protection;
                var totalAmountInput = $('#amount');
                var originalAmount = parseFloat(totalAmountInput.data('original-amount'));

                // Update the amount with the credit shield fee
                totalAmountInput.val(originalAmount + creditShieldFee);

                // Display the credit shield fee in #collapseOne after the processing fee
                var creditShieldDiv = '<div class="col">Credit Shield Fee: RM' + creditShieldFee.toFixed(2) +
                    '</div>';
                $('.processing_fee_div').after(creditShieldDiv);
            }
        });
    }
    ...
    function payment() {
        ...
        $.ajax({
            ...
            success: function(response) {
                console.log(response);
                if (response.status == 'success') {
                    if ('chargeNowWithOtpUrl' in response.payment_response) window.location.replace(response
                        .payment_response.chargeNowWithOtpUrl);
                } else {
                            ...
                            if (response.billStatus != null) {
                                if (response.billStatus.billing_stage_id != billing_stage_id) {
                                    if (response.billStatus.billing_stage_id == 8 || response
                                        .billStatus
                                        .billing_stage_id == 2) {
                                        if (response.billStatus.callback_status == '1' && (response
                                                .billStatus.callback_url.includes('wc-api') ||
                                                response.billStatus.callback_url.includes(
                                                'shopify') || response.billStatus.callback_url
                                                .includes('route=payment/airapay/callback_ipn')) &&
                                            response.callback_res.redirect == true) {
                                            if (response.billStatus.callback_url.includes(
                                                'shopify'))
                                                window.location.replace(response.billStatus
                                                    .return_url);
                                            else if (typeof response.callback_res.url !==
                                                'undefined')
                                        ...
                                        if (response.billStatus.callback_status == '1' && (response
                                                ...
                                                'shopify') || response.billStatus.callback_url
                                                .includes('route=payment/airapay/callback_ipn')) &&
                                            response.callback_res.redirect == false) {
                                            if (response.billStatus.callback_url.includes(
                                                'shopify'))
                                                window.location.replace(response.billStatus
                                                    .return_url);
                                        ...
                                        if ($('#time').html() == '00:00') {
                                            ...
                                            if (return_url.indexOf('?') > -1) {
                                                var redirect_url = return_url +
                                                    '&transactionStatus=1&transactionType=1&billStatus=2&ref=' +
                                                    response.billStatus.merchant_ref +
                                                    '&billCode=' +
                                                    bill_code;
                                            } else {
                                                var redirect_url = return_url +
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status == 'success') {
                            if (return_shopify_url != 'null' && return_shopify_url != '') window
                                .location.replace(return_shopify_url);
                            if (!isRedirected) {
                                isRedirected = true;
                                window.location.replace(redirect_url);
                            }
                    ...
                    if (platform_vouchers != null) {
                        for (i = 0; i < platform_vouchers.length; i++) {
                            ...
                            if ((parseInt(min_purchase_amount) > parseInt(bill_amount)) || (
                                    ...
                                    platform_vouchers[i].disable == "true")) {
