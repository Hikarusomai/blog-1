...
' VPX7.2 - version by JPSalas 2022, version 4.0.1
...
Sub table1_Init
    ...
    With Controller
        ...
        .SplashInfoLine = "Panthera Gottlieb 1980" & vbNewLine & "VPX table by JPSalas v4.0.1"
...
Sub Realtime_Timer
    RollingUpdate
    GIUpdate
    LeftFlipper_top.RotZ = LeftFlipper.CurrentAngle
    RightFlipper_top.RotZ = RightFlipper.CurrentAngle
End Sub
